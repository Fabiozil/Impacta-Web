...
@section('content')
    ...
    <div class="row main-r w-100">
        <div class="container cont-rec h-100 main-cr mr-0">    
            ...
            <button type="submit" class="btn btn-primary" style="margin-bottom: 10px; margin-left: -15px">Regresar</button>
        </div>
    ...
    <div class="modal-dialog modal-lg" role="document" >
        <div class="modal-content" >
         <div class="modal-header">
            <h4 class="modal-title" id="favoritesModalLabel">Datos del usuario</h4>
