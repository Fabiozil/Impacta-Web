...
<div class="py-5 text-center" style="height: 20%">
    ...
    <p class="lead">Ingresa la informacion necesaria para ingresar al sistema un nuevo reciclador</p>
</div>
                ...
                <div class="row" style="height: 100%">
                    <div class="col-12">
                        <div class="py-5 text-center" style="height: 20%">
                            ...
                            <p class="lead">Ingresa la informacion personal del reciclador</p>
                        </div>
                        <form>
        ...
        <div class="col-12">
            <div class="row">
                <div class="container" id="contenedor-formulario" style="height: 100%">
                    <div class="py-5 text-center" style="height: 20%">
                        <h2>Mi historia</h2>
                        <p class="lead">Ingresa la historia de este reciclador la cual sera visible para sus usuarios
                            asignados</p>
                    </div>
                    <div class="container">
    ...
    <div class="row" style="height: 100%;">
        <div class="container" id="contenedor-formulario">
            <div class="py-5 text-center" style="height: 20%; margin-bottom: 10px">
                <h2>Mi labor</h2>
                <p class="lead">Ingresa la informacion acerca de rutas y residuos recolectados</p>
            </div>
            <div class="row">
                <div class="container" id="contenedor-formulario">
                    <div class="col-12" style="height: 100%;">
                        <div class="row align-items-center">
                            <div class="col-5">
                                <h5 style="text-align: center; width: 100%;">Residuos que recolecto</h5>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
