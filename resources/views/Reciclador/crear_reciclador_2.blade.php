        ...
        <div class="row" style="height: 100%;">
            <div class="col-2" style="height: 100%; background-color:  #cccccc;">
                <div class="row" style="margin: 10px;">
                    <a href="crear_reciclador" style="width: 100%;">
            ...
            <div class="col-10" style="background-color: #f2f2f2; height: 100%;">
                <div class="row" style="height: 100%;">
                <div class="col-12"> 
                    <div class="row " style="background-color: white; height: 90%; margin: 20px; border-radius: 10px;">
                        <div class="col-12" style="margin-top: 20%;">
                            <h1 style="color: #009900; text-align: center; width: 100%;;">Ingresa un nuevo reciclador</h1>
                            <h2 style="text-align: center; width: 100%;">Mi historia</h2>
                            <form>
                                <div class="input-group">
                                    <textarea class="form-control"></textarea>
                                </div>
                            </form>
                            <a href="crear_reciclador_3">
