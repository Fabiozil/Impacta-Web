    ...
    <div class="card-body">
        <div class="row">
            <div class="col-xl-4 col-sm-12">
                <img class="border border-success rounded-circle" style="display: block ;margin-left: auto; margin-right: auto; max-width: 100%; max-height: 100%" src="{{url("/Michel.jpg")}}" alt="Michele Osama">
                <h3 class="text-center mb-1 pb-1">Michel Osama</h3>
                <p class="text-center lead">Miembro hace 1 día</p>
            </div>
            <div class="col-xl-8 col-sm-12">
                <h3 class="py-4 text-center">Informacion general</h3>
                <p class="text-center">Dirección: Diagonal 28C 28 sur 25</p>
                <p class="text-center">Municipio de Envigado</p>
                <p class="text-center">Metodo de recoleccion: Deja el reciclaje en la puerta de la casa</p>
