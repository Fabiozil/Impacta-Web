        ...
        <div class="row">
            <div class="col-xl-4 col-sm-12">
                <img class="imgRecycler border border-success rounded-circle imgpg"
                    style="max-width: 100%; max-height: 100%" src="{{url("/unidad1.jpg")}}" alt="Michele Osama">
                <h3 class="text-center mb-1 pb-1 mt-2"><strong>Torres del riachuelo</strong></h3>
                <p class="text-center">Miembro hace 1 año</p>
            </div>
            <div class="col-xl-8 col-sm-12">
                <h2 class="py-4 text-center"><strong>Informacion del usuario</strong></h2>
                <p class="text-center lead"><strong>Reciclador asignado: </strong> German Exequiel Cano</p>
                <p class="text-center lead"><strong>Tipo de usuario: </strong> Administracion residencial</p>
                <p class="text-center lead"><strong>Municipio: </strong> Itagui</p>
                <p class="text-center lead"><strong>Dirección: </strong> Calle 62B Carrera 50</p>
                <p class="text-center lead"><strong>Condición de entrega: </strong>Recoger en portería</p>
