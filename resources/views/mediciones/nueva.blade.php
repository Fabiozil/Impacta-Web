...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $(addButton).click(function(){
            ...
            <div class="form-row">
                <div class="col">
                    <label for="organico">KG Orgánicos</label>
                    <br />
                    <div class="input-group">
                        <input type="number" class="form-control @error('number') is-invalid @enderror"id="organico"name="number"value="0"required/>
                        @error('number')
                ...
                <div class="col">
                    <label for="vidrio">KG Vidrio</label>
                    <br />
                    <input class="form-control" type="number" id="vidrio" name="vidrio"value="0"/>
                </div>
                <a href="javascript:void(0);" class="btn btn-danger remove_button">Remover</a>
            </div>
            <br>`; //New input field html 
