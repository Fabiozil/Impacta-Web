...
<div class="card">
                        ...
                        <div class="card-body table-responsive">
                            ...
                            <table class="table table-borderless table-hover table-light mt-2 " id="datosZona">
                                ...
                                <tbody id="lista-residuos">
                                    <tr>
                                        <th>No hay materiales seleccionados.</th>
                                    </tr>
                                    <tr>
                                    </tr>
                                </tbody>
                ...
                <div class="modal-content ">
                    <form>
                        <div class="modal-header ">
                            <h5 class="modal-title text-success" id="tituloHistoria">Mi Historia</h5>
        ...
        <div class="modal fade" id="editarInfoPerson" tabindex="-1" role="dialog" aria-labelledby="info_personal"
            ...
            <div class="modal-dialog  modal-lg modal-dialog-centered" role="document">
                <div class="modal-content ">
                    <form>
                        <div class="modal-header ">
                            <h4 class="modal-title-center text-success text-center"> Información Personal</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
    ...
    <div class="card-footer">
        <div class="d-flex justify-content-end">
            <a data-toggle="modal" data-target="#detallesModal" class="btn btn-danger">Eliminar</a>
...
<div class="modal fade" id="editarZona" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog  modal-lg modal-dialog-centered" role="document">
        <div class="modal-content ">
            <div class="modal-header ">
                <h2 class="modal-title text-success" id="tituloHistoria"></i>Zonas de recolecci&oacute;n</h2>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<div class="modal fade" id="editarMateriales" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog  modal-lg modal-dialog-centered" role="document">
        <div class="modal-content ">
            <div class="modal-header ">
                <h4 class="modal-title text-success" id="tituloHistoria">Materiales de recolección</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                        ...
                        <div class="col-md-11">
                            ...
                            <table class="table table-borderless table-hover table-light mt-2 " id="datosZona">
                                ...
                                <tbody id="Blista_residuos">
                                    <tr>
                                        <th>No hay materiales selecionados.</th>
                                    </tr>
                                </tbody>
